...
motor RightBackMotor = motor(PORT3, ratio6_1, true);
...
motor FlywheelMotorsMotorA = motor(PORT2, ratio6_1, false);
motor FlywheelMotorsMotorB = motor(PORT4, ratio6_1, true);
